...
<!--okf:intro-->
External specifications and papers read in full, with their principles
distilled so an agent does not need to re-fetch them. Each carries a
`resource:` link to the original.
<!--/okf:intro-->
