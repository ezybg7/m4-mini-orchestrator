...
type: index
title: references
description: Index of 5 concept(s) under references/.
tags: [index]
...
<!--okf:intro-->
Layer 3 reference material: the stable rules that persist across every run.
Internalize these as constraints, not as input.

Durable *knowledge* (what is true about a project) lives in
[`../memory/`](../memory/index.md); this folder holds *how we work*.
<!--/okf:intro-->
